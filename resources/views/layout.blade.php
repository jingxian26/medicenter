...
@if(Session::has('success'))
  ...
  <a class="navbar-brand" href="/">Inter MediCenter</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="detailDoctors">Doctors</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admin">Admin</a>
      </li>    
    </ul>
    <form class="form-inline my-2 my-lg-0" action="{{route('search.doctor') }}" method="POST">
      @csrf
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-3 footer_col">
          ...
          <div class="footer_social">
            <a href="">
              <i class="fas fa-facebook" aria-hidden="false"></i>
            </a>
            <a href="">
      ...
      <div class="footer-info">
        <p>
          ...
          <a href="https://html.design/">Inter MediCenter</a>
        </p>
      </div>
    </div>
  </footer>
